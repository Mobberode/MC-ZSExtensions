...
execute as @a[tag=zsextension_exomoves.dashing] if entity @e[tag=zsextension_exomoves_move_doll,limit=1,sort=nearest,nbt={OnGround:false}] run schedule function exomoves:contents/global/moves/teleport_spam 1t
